...
public class ApprovalVisitor implements FreshInsuranceVisitor {
    ...
    private boolean approveBasicInsuranceInfo(int insuranceId, C_InsuranceProduct insuranceProductController, BufferedReader objReader) throws IOException {
        ...
        if(approvalInput) {
            ...
            System.out.println(insuranceProductController.approvalBasicInsuranceInfo(insuranceId, true));
    ...
    private boolean approveMemberPaperForm(int insuranceId, C_InsuranceProduct insuranceProductController, BufferedReader objReader) throws IOException {
        ...
        boolean approvalInput = InsuranceTui.getBoolean(objReader);
        if(approvalInput) { System.out.println(insuranceProductController.approvalMemberPaperForm(insuranceId, true));
        }else {System.out.println(insuranceProductController.approvalMemberPaperForm(insuranceId, false));}
        return approvalInput;
    }
